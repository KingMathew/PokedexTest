//
//  ItemDetailRemoteDataManager.swift
//  PokedexTest
//
...
class ItemDetailRemoteDataManager:ItemDetailRemoteDataManagerInputProtocol {
    
    var remoteRequestHandler: ItemDetailRemoteDataManagerOutputProtocol?
