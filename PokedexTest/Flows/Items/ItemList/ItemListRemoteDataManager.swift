//
//  ItemListRemoteDataManager.swift
//  PokedexTest
//
...
class ItemListRemoteDataManager: ItemListRemoteDataManagerInputProtocol {

    var remoteRequestHandler: ItemListRemoteDataManagerOutputProtocol?
